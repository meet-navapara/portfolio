      ...
      <div className="projects">
        ...
        <Fade animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>SMEHA fashion ecommerce</h3>
              <p>This e-commerce website project is built using the MERN stack (MongoDB, Express.js, React.js, and Node.js) to provide a responsive, scalable, and user-friendly online shopping experience. It includes core features such as user authentication, product browsing with categories and filters, cart and wishlist management, secure checkout with payment gateway integration, and order tracking. Admin functionality allows for managing products, categories, orders, and users through a dedicated dashboard. The site is designed to be mobile-responsive and supports modern UI/UX practices for an intuitive user experience.        .</p>
            </div>
            <footer>
        ...
        <Fade animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>ChatApp</h3>
              <p>This chat application, developed using the MERN stack (MongoDB, Express.js, React.js, and Node.js), provides real-time messaging functionality with a clean and responsive user interface. Users can register, log in securely, manage their profiles, and engage in one-on-one or group chats. Real-time communication is enabled using Socket.IO, ensuring instant message delivery and typing indicators. The backend manages user sessions, message storage, and chat history, while the frontend offers features like chat lists, message notifications, and online status indicators. The app is optimized for performance and scalability, making it suitable for both web and mobile use</p>
            </div>
            <footer>
            <ul className="tech-list">
                <li>HTML</li>
        ...
        <Fade animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
              This medical management system, built using the MERN stack (MongoDB, Express.js, React.js, and Node.js), focuses on streamlining healthcare operations through dedicated modules for staff, clients, and lesson programs. As a full-stack developer, I implemented features that allow administrators to manage staff profiles, schedules, and roles, while clients can register, book appointments, and access their medical lesson programs. The lesson program module supports structured health or therapy-related sessions with progress tracking and scheduling. The system ensures secure authentication, role-based access, and a responsive UI for seamless interaction across all user types.        
              </p>
            </div>
            <footer>
            <ul className="tech-list">
